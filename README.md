# Dekódovanie tajnej správy z obrázku formátu PPM
...
Poznámky:  Eratosthenovo síto (přibližná specifikace):
   ...
   Efektivita výpočtu: cca 2.1s na Intel i5-4690 @ 3.50GHz (gcc -O2)
